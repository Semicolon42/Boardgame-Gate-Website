...
export const TUTORIAL_SLIDES: TutorialSlide[] = [
	...
	// -------------------------------------------------------------------------
	{
		...
		description: (
			<>
				...
				The <K>Village Row</K> is where you recruit allies. Your{' '}
				<K>Base</K> buildings and <K>Fear</K> tracker sit in the middle.
				Your <K>Hand</K> of cards is at the bottom.
			</>
		)
	},
	...
	// -------------------------------------------------------------------------
	{
		...
		description: (
			<>
				Spend <K>Coins</K> (generated by playing cards) to recruit villagers from
				the <K>Village Row</K>. Each card shows its <K>cost</K> in the top
				corner.
				<br />
				<br />
	...
	// -------------------------------------------------------------------------
	{
		...
		annotations: [
			{id: 'tutorial-base', placement: 'top', text: 'Farm · Gate · Tower · Fear'}
		],
		description: (
			<>
				...
				building, or eventually causing a{' '}
				<K>game over</K> if it reaches the top.
			</>
		)
	},
	...
	// -------------------------------------------------------------------------
	{
		...
		description: (
			<>
				...
				<br />
				<strong>3. End Turn</strong> — Click <K>End Turn</K>. Enemies attack your
				base, a new enemy may enter, and you draw a fresh hand of{' '}
				<K>3 cards</K>.
				<br />
				<br />
				<K>Win</K> by defeating all enemies. <K>Lose</K> if your Gate falls to
				0 or fear reaches the top of the pyramid.
			</>
		)
	}
]
